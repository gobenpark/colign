          ...
          <CardContent>
            ...
            <Tabs defaultValue="login" onValueChange={() => setError("")}>
              <TabsList className="grid w-full grid-cols-2">
                <TabsTrigger value="login" className="cursor-pointer">{t("common.signIn")}</TabsTrigger>
                <TabsTrigger value="register" className="cursor-pointer">{t("common.signUp")}</TabsTrigger>
              </TabsList>
